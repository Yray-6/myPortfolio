...
export default function Contact() {
  ...
  return (
    ...
    >
      <motion.div
        className="basis-1/2 flex flex-col gap-[30px] "
        variants={variants}
      >
        <motion.p
      ...
      <div className="basis-1/2 ">
        ...
        >
          <input
            type="text"
            className="bg-transparent  border-gray-500 border-[0.5px] p-3 rounded"
            required
            placeholder="Name"
            name="name"
          />
          <input
            ...
            required
            placeholder="Email"
            className="bg-transparent rounded border-gray-500 border-[0.5px] p-3"
          />
          <textarea
            rows={8}
            placeholder="Message"
